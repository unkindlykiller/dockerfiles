...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
    ...
    <Url type="application/atom+xml" template="<?php echo $serverurl;?>?do=atom&amp;searchterm={searchTerms}"/>
    <Url type="application/rss+xml" template="<?php echo $serverurl;?>?do=rss&amp;searchterm={searchTerms}"/>
